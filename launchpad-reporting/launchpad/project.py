# This is a wrapper, which converts launchpad project structure into a
...
class Project():
    ...
    def __init__(self, lpproject):
        ...
        # straight copy fields from the lpbug object.
        # this do not make any calls to LP
        ...
        self.active_milestones = [
            str(m.name) for m in lpproject.active_milestones]
